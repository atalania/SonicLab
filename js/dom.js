...
export const el = {
  ...
  statLastOral:        $('stat-last-oral'),
  statLastDelta:       $('stat-last-delta'),
  meterHint:           $('meter-hint'),
  ...
  questionCoachContent:      $('question-coach-content'),
  questionCoachOpenTutorial: $('question-coach-open-tutorial'),
};
